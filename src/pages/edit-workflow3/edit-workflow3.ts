    ...
    this.wfAgeingDetails = [
      [
        ...
        {title: "充电电压", method: "table", size: 6, data:[
          {label: "AG1", model:"wfAge1AG1",type:"number"},
          {label: "AG2", model:"wfAge1AG2",type:"number"},
          {label: "AG3", model:"wfAge1AG3",type:"number"},
          {label: "AG4", model:"wfAge1AG4",type:"number"},
          {label: "AG5", model:"wfAge1AG5",type:"number"},
          {label: "AG6", model:"wfAge1AG6",type:"number"},
          {label: "AG7", model:"wfAge1AG7",type:"number"},
          {label: "AG8", model:"wfAge1AG8",type:"number"},
        ]},
