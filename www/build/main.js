  ...
  */
    ...
    WorkflowPage.prototype.dataSubmission = function (form) {
        ...
        this.wfSvc.query(form.value, form.value.wfForm).subscribe(function (serverData) {
            ...
            _this.loadDataToForm(form, serverData[0]);
            ...
            _this.storage.get(form.value.wfFormId).then(function (storageData) {
                if (storageData) {
                    ...
                    // this is to assume the latest input from user is always correct
                    // Only will override if there is no input at all
                    _this.loadDataToForm(form, storageData);
                }
    ...
    WorkflowPage.prototype.loadDataToForm = function (form, data) {
...
var EditWorkflow1Page = (function () {
    ...
    */
    EditWorkflow1Page.prototype.setFormValue = function (model, value) {
        //It is used for html
        var form = this.wfInputForm;
        form.controls[model].setValue(value);
    };
...
var EditWorkflow3Page = (function () {
    ...
    EditWorkflow3Page.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad 电容器流程卡');
        console.log("wfNavParams: " + this.wfNavParams);
        console.log("appDate is " + this.appDate);
    };
    ...
    EditWorkflow3Page.prototype.setFormValue = function (model, value) {
        var form = this.wfInputForm;
        form.controls[model].setValue(value);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__workflow__ = __webpack_require__(53);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QRCodeService = (function () {
    function QRCodeService(storage, QR, wfSvc) {
        this.storage = storage;
        this.QR = QR;
        this.wfSvc = wfSvc;
    }
...
QRCodeService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ionic_storage__["b" /* Storage */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__ionic_native_barcode_scanner__["a" /* BarcodeScanner */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__ionic_native_barcode_scanner__["a" /* BarcodeScanner */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__workflow__["a" /* WorkflowService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__workflow__["a" /* WorkflowService */]) === "function" && _c || Object])
], QRCodeService);
