                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            console.log("uploading form" + JSON.stringify(form_1.value));
                                        ...
                                        handler: function () {
                                            ...
                                            _this.wfSvc.upload(form_1.value, 1)
                                                ...
                                                if (_this.images.length > 0) {
                                                    ...
                                                    var imgTotal = _this.images.length;
                                                    for (var i = 0; i < imgTotal; i++) {
                                                        _this.wfSvc.uploadImage(form_1, 1, _this.images[i], i, imgTotal)
                                                            .subscribe(function (data) {
                                                            console.log("Successfully uploading to server");
                                        ...
                                        handler: function () {
                                            ...
                                            _this.upload(form_1.value, 1)
                                                ...
                                                if (images.length > 0) {
                                                    ...
                                                    for (var i = 0; i < imgTotal; i++) {
                                                        _this.uploadImage(form_1, 1, images[i], i, imgTotal)
                                                            .subscribe(function (data) {
                                                            console.log("Successfully uploading to server");
                                                            console.log("Upload img reply from server" + JSON.stringify(data));
                                                        }, function (error) {
